...
# For References 
By only including [readable-stream](https://www.npmjs.com/package/readable-stream) for browser without anything else you have  included the buffer, events and inherits module among many more smaller modules and already broken 4 of this rules and increased your bundle to: 
